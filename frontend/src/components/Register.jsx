    ...
    return (
        <div className='min-h-[calc(100vh-120px)] flex items-center justify-center'>
            <div className="w-full max-w-md mx-auto bg-white rounded-lg px-8 pt-6 pb-8 mb-4 border border-gray-200 shadow-lg">
                <h2 className='text-2xl font-bold mb-6 text-red-900 text-center'>Create an Account</h2>
                ...
                <p className="text-center font-medium mt-6 text-sm text-gray-700">
                    ...
                    <Link to="/login" className='text-red-900 hover:text-red-800 ml-1 font-semibold'>
                        Login here
                    </Link>
                </p>
